...
public final class CatalogoPreguntas {
    ...
    public static final List<DefPregunta> TODAS = List.of(
            ...
            new DefPregunta("montana", "¿Te gustaría visitar zonas de montaña?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            new DefPregunta("naturaleza", "¿Te interesa estar en contacto con la naturaleza (parques, reservas, bosques)?", TipoAtributo.AUTO, "national_park,leisure.park,natural.forest", 12, Peso.GUSTO),
            new DefPregunta("aventura", "¿Te gustaría hacer actividades de aventura (senderismo, rafting, etc.)?", TipoAtributo.AUTO, "leisure.park.nature_reserve,sport.sports_centre,entertainment.activity_park", 8, Peso.GUSTO),
            new DefPregunta("deportes_extremos", "¿Te interesan actividades como parapente, buceo o escalada?", TipoAtributo.AUTO, "sport.dive_centre,sport.climbing,activity.sport_club", 3, Peso.GUSTO),
            new DefPregunta("gastronomico_destacado", "¿Te interesa un destino especialmente reconocido por su gastronomía?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            ...
            new DefPregunta("gourmet", "¿Te interesan los restaurantes de alta cocina o gourmet?", TipoAtributo.AUTO, "catering.restaurant.fine_dining", 3, Peso.GUSTO),
            ...
            new DefPregunta("relajacion", "¿Buscas principalmente descansar y desconectarte?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            new DefPregunta("tranquilo", "¿Prefieres un destino tranquilo y poco agitado?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            ...
            new DefPregunta("cultura_historia", "¿Te interesa conocer la cultura, historia y patrimonio del destino?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            ...
            new DefPregunta("familiar", "¿Quieres un destino especialmente recomendado para viajar en familia?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            ...
            new DefPregunta("isla_caribe", "¿Quieres un destino de islas o ambiente caribeño?", TipoAtributo.MANUAL, "", 0, Peso.EXCLUYENTE),
            new DefPregunta("vino", "¿Te interesa un destino famoso por vinos o viñedos?", TipoAtributo.MANUAL, "", 0, Peso.GUSTO),
            new DefPregunta("ruinas_arqueologicas", "¿Te interesan ruinas o sitios arqueológicos?", TipoAtributo.MANUAL, "", 0, Peso.FUERTE),
            new DefPregunta("festivo", "¿Buscas un destino con carnaval o festivales famosos?", TipoAtributo.MANUAL, "", 0, Peso.GUSTO),
            new DefPregunta("off_the_beaten_path", "¿Prefieres un destino menos turístico o fuera de la ruta tradicional?", TipoAtributo.MANUAL, "", 0, Peso.GUSTO),
            ...
            new DefPregunta("aguas_termales", "¿Te interesan aguas termales o balnearios?", TipoAtributo.AUTO, "leisure.spa.public_bath", 2, Peso.GUSTO),
            new DefPregunta("cascadas_rios", "¿Te gustaría visitar cascadas o ríos?", TipoAtributo.AUTO, "natural.water.waterfall,natural.water.spring", 3, Peso.GUSTO),
            new DefPregunta("buceo_snorkel", "¿Te gustaría hacer buceo o snorkel?", TipoAtributo.AUTO, "sport.dive_centre", 2, Peso.GUSTO),
            new DefPregunta("teatro_musica", "¿Buscas un destino con teatros o música en vivo?", TipoAtributo.AUTO, "entertainment.culture.theatre,entertainment.culture", 4, Peso.GUSTO),
            ...
            new DefPregunta("golf", "¿Te interesa jugar golf durante el viaje?", TipoAtributo.AUTO, "sport.golf", 1, Peso.GUSTO)
    );
