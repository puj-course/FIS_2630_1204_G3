...
public final class CatalogoPreguntas {
    ...
    private CatalogoPreguntas() {
        ...
        public static final List<DefPregunta> TODAS = List.of(
                ...
                new DefPregunta("naturaleza","¿Te interesa estar en contacto con la naturaleza (parques, reservas, bosques)?", TipoAtributo.AUTO, "national_park,leisure.park,natural.forest,natural.water.waterfall,natural.water.spring", 12, Peso.GUSTO),
